...
//
// Запрос 3: Выбирает из таблицы ВРАЧИ информацию о врачах, имеющих специальность «хирург», стоимость приема которых составляет больше 1000 рублей
echo "<h2>Запрос 3: Выбирает из таблицы ВРАЧИ информацию о врачах, имеющих специальность «хирург», стоимость приема которых составляет больше 1000 рублей</h2>";
try {
    ...
    $query = "SELECT * FROM DOCTORS WHERE SPECIALITY_DOCTOR = 'Хирург' AND COST_OF_ADMISSION > 1000";
