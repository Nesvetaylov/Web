...
try {
    ...
    $query = "SELECT d.DOCTOR_ID, d.FIO_DOCTOR, d.SPECIALITY_DOCTOR, a.COST_OF_ADMISSION, d.PERCENTAGE_OF_SALARY, (a.COST_OF_ADMISSION * d.PERCENTAGE_OF_SALARY) AS Зарплата
              FROM DOCTORS d
